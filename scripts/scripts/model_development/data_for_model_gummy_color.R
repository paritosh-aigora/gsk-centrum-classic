...
product_keys <- readxl::read_excel(file.path("input", "data_keys", "gummy_color_data_key.xlsx"),
                                   "Sample Info") %>%
